...
NAMING RULE: never say "SEP" anywhere user-facing — it is "the plan algorithm" and "relationship recommendation." (The old code's SepExplain/sepScore/SEP_* names must be renamed.)
...
6) PRIORITY STAKEHOLDERS + RELATIONSHIP RECOMMENDATIONS [FIX] — first the PRIORITY stakeholders (by the stakeholder's existing manual Priority, high first), THEN stakeholders whose RELATIONSHIP RECOMMENDATION aligns with the picked plan algorithm. (Define the alignment deliberately; never surface "SEP".) Plus the free-add paths: add any workspace stakeholder, any Master stakeholder, or create-new (→ added to plan + workspace).
