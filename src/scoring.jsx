...
export function ScoringView({ addNonce, addNonceFor, addStakeholder, workspaces, companyIssues, community, stakeholders, scores, team, updateScore, updateTeam, addTeamMember, removeTeamMember, workspaceLabel, users, currentUser, workspaceOwners, onDeleteWorkspace }) {
  const { weightedCoord, statusFor } = STAKEHOLDER_DATA;
