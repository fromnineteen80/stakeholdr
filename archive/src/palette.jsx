...
export function CommandPalette({ open, onClose, stakeholders, plans, community, workspaces, users, onGo }) {
  ...
  if (ql) {
    stakeholders.forEach(s => {
      ...
      const site = s.site && STAKEHOLDER_DATA.SITES ? (STAKEHOLDER_DATA.SITES.find(x => x.id === s.site) || {}) : {};
      const siteStr = site.id ? STAKEHOLDER_DATA.siteLabel(site) : "";
