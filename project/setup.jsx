...
function WorkspaceCard({ ws, isActive, count, markets, regions, onActivate, onDelete, onEdit, onUpdate, users, canDelete }) {
  const D = window.STAKEHOLDER_DATA;
  return (
...
function WorkspaceModal({ open, mode, ws, users, currentUser, onClose, onSave, segMap }) {
  const D = window.STAKEHOLDER_DATA;
...
function SegmentBadge({ segment, small }) {
  const map = {
...
Object.assign(window, { SetupView, SegmentBadge, GeographyChip, WorkspaceCard, WorkspaceModal });
