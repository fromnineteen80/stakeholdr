  ...
  return (
    <div className="community-wrap">
      ...
      <div className="community-toolbar">
        <div className="search"><Icon name="search" /><input placeholder="Search…" value={search} onChange={e => setSearch(e.target.value)} /><span className="kbd kbd-cmdk">{window.cmdKeyLabel}</span></div>
