...
function SettingsView({ users, currentUser, updateUserRole, appConfig, updateAppConfig, companyIssues, updateCompanyIssues, companyTags, updateCompanyTags, companyFunctions, updateCompanyFunctions, companyMarkets, updateCompanyMarkets, companySites, updateCompanySites, companySegments, updateCompanySegments, companyCategories, updateCompanyCategories, companyGoals, updateCompanyGoals }) {
...
function BeakerColorField({ value, onChange }) {
  return (
...
Object.assign(window, { SettingsView, BeakerColorField });
